...
import { Search, Bell, User, Settings, LogOut, UserCircle, Sparkles, ArrowLeft, X as XIcon } from 'lucide-react'
      ...
      <div className="flex items-center gap-2 sm:gap-4 px-4 sm:px-6 h-16 min-w-0">
        ...
        <div className="hidden sm:flex flex-1 min-w-0 ml-0 lg:ml-0">
          <div className="relative w-full max-w-sm lg:max-w-md xl:max-w-lg">
            ...
            <motion.div
              animate={{ borderColor: searchFocused ? 'var(--cr-accent-border)' : undefined }}
        ...
        {/* Mobile: spacer to push actions right (hamburger sits fixed at left) */}
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 flex-shrink-0">
          ...
          <motion.button
            ...
            className="sm:hidden w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200"
            style={{
            ...
            <div ref={dropdownRef} className="relative flex-shrink-0">
              ...
              >
                {avatarUrl ? (
                  ...
                  <img src={avatarUrl} alt={username} className="w-9 h-9 rounded-full object-cover ring-2 ring-[#F5C518]/35 hover:ring-[#F5C518]/65 transition-all" />
                ) : (
                  <div
                    ...
                    style={{ background: 'linear-gradient(135deg, #F5C518 0%, #FFB800 100%)', boxShadow: '0 4px 14px rgba(245,197,24,0.28)' }}
                  >
          ...
          <div className="sm:hidden">
            <div
              className="w-8 h-8 rounded-full flex items-center justify-center ring-2 ring-[#F5C518]/25"
              style={{ background: 'linear-gradient(135deg, #F5C518 0%, #FFB800 100%)' }}
            >
              <User size={14} className="text-[#1A1A1A]" strokeWidth={2.2} />
            </div>
          </div>
        </div>
      </div>
        ...
        {mobileSearchOpen && (
          <>
            ...
            <motion.div
              ...
              className="sm:hidden fixed left-0 right-0 top-0 z-50 px-4 pt-4 pb-5 shadow-2xl"
              style={{
                ...
                >
                  ...
                  {searchValue && (
                    <button onClick={() => setSearchValue('')} className="flex-shrink-0 ml-1">
                      <XIcon size={14} style={{ color: isDark ? '#71717A' : '#9CA3AF' }} />
                    </button>
                  )}
                </div>
              </div>
